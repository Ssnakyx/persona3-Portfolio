...
const ITEMS = [
  {
    id: "github", label: "GITHUB", handle: "@Ssnakyx", href: "https://github.com/Ssnakyx", icon: "💻", barIcon: icon1, bars: 3, newBars: [0], counts: ["PROFILE", "REPOS", "PORTFOLIO"],
    links: ["github.com/Ssnakyx", "github.com/Ssnakyx?tab=repositories", "github.com/Ssnakyx/persona3-Portfolio"],
    stats: [
      { tag: "REPO", value: "10+", color: "#6e5494" },
      { tag: "STR",  value: "5+",  color: "#4078c0" },
    ],
  },
  {
    id: "linkedin", label: "LINKEDIN", handle: "@hamed-kaffa", href: "https://www.linkedin.com/in/hamed-kaffa-98587032a/", icon: "🔗", barIcon: icon2, bars: 1, newBars: [0], counts: ["PROFILE"],
    links: ["linkedin.com/in/hamed-kaffa-98587032a/"],
    stats: [
  ...
  {
    id: "email", label: "EMAIL", handle: "hamed0405n@gmail.com", href: "mailto:hamed0405n@gmail.com", icon: "📧", barIcon: icon3, bars: 1, newBars: [0], counts: ["CONTACT"],
    links: ["mail.google.com/mail/?view=cm&to=hamed0405n@gmail.com"],
    stats: [
